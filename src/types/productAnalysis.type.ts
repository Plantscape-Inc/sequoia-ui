export interface CSICategoryAnalysisOverview {
    overview: {
        categoryMonthlyCountsCategory: { [key: string]: Array<CSICategoryMonthlyCountCategory> }
        categoryMonthlyRevenuesCategory: { [key: string]: Array<CSICategoryMonthlyRevenueCategory> }
        categoryMonthlyCountsMonth: { [key: string]: Array<CSICategoryMonthlyCountMonth> }
        categoryMonthlyRevenuesMonth: { [key: string]: Array<CSICategoryMonthlyRevenueMonth> }
    }
}
