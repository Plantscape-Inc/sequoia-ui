...
export default function Nav() {
  ...
  return (
    <>
      ...
      <div
        className={`bg-opacity-50 fixed inset-0 z-50 bg-black transition-opacity ${
          isOpen
      ...
      >
        <div
          className={`fixed top-0 left-0 h-full w-64 transform bg-white shadow-md transition-transform dark:bg-gray-900 ${
