...
const OrderDisplayRaw: React.FC<OrderDisplayProps> = ({ orderData }) => {
    ...
    return (
        <div className="p-6 space-y-6 text-gray-900 dark:text-gray-200">
            <section className="bg-white dark:bg-gray-800 rounded-lg shadow p-1">
                ...
                <Accordion flush={true}>
                    <AccordionPanel key={"customer"}>
                        <AccordionTitle key={"customer"} className="p-1">
                            <span className="text-2xl font-semibold mb-2 text-gray-900 dark:text-gray-200">Customer Info</span>
                        </AccordionTitle>
                        <AccordionContent>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
