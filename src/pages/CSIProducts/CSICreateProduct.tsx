...
const subcategories: Record<string, string[]> = {
    ...
    "CLD": ["CON", "WFL", "WSL", "WFD", "PFL", "PFP", "FRM", "STK", "FCT", "NCH", "BLD", "EXP", "LAT", "FAB", "FMD"],
    "GRD": ["FLD", "FPG", "SEC", "BLD", "WFL", "TLE", "PFL", "PLG", "NCH"],
    "SUR": ["BLD", "PLG", "FPG", "PFL", "PNL", "PFP", "PNP", "FLD", "TXD", "STK", "OLP", "LNE", "CRV", "CRK", "CRL", "COV", "EXD", "ECH"],
...
export default function CSICreateProduct({ product }: ProductCardProps) {
    ...
    const [requestStatus, setRequestStatus] = useState<"success" | "warning" | "error" | null>(null);
    ...
    const handleChangeDebounced = (field: keyof CSIProduct, value: string | number) => {
        ...
        debounceRef.current = setTimeout(() => {
            setEditableProduct(prev => {
                ...
                setProductId(`CSI-${inputRefs.current["categoryid"] ?? prev.categoryid
                ...
                setBaseProductId(`CSI-${inputRefs.current["categoryid"] ?? prev.categoryid
                    }-${inputRefs.current["subcategoryid"] ?? prev.subcategoryid
                    }`);
    ...
    const submitNewCsiProduct = (product: CSIProduct) => {
        ...
        console.log(product)
        console.log(`${API_URL}/csi/createProduct`)
    ...
    return (
        <div className="max-w-4xl min-w-[800px] mx-auto mt-6 shadow-lg bg-gray-800 p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700 dark:text-gray-200">
                ...
                <div className="space-y-2">
                    {([
                            ...
                            return (
                                <div key={field} className="flex justify-between items-center">
                                    ...
                                    <Select
                                        ...
                                        onChange={e => handleChangeDebounced(field, e.target.value)}
                                        className={`w-64 text-right ${editableProduct[field] === editableProduct[field]
                                            ? "border-white"
                                            : "border-red-500"
                                            }`}
                                    >
                        ...
                        if (field === "subcategoryid") {
                            const selectedCategory = editableProduct.categoryid || Object.keys(subcategories)[0];
                            return (
                                <div key={field} className="flex justify-between items-center">
                                    <span className="font-semibold">{label}:</span>
                                    <Select
                ...
                <div className="space-y-2">
                    ...
                    <div key="submit" className="flex justify-between items-center">
                        ...
                        <Button
                            onClick={() => { submitNewCsiProduct(editableProduct) }}
            ...
            {(() => {
                switch (requestStatus) {
                    case "success":
                        return <div className="w-[100%] m-2 p-4 rounded-4x1 bg-green-600"><h4 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Product Made</h4></div>;
                    case "warning":
                        return <div className="w-[100%] m-2h-10 m-0 bg-yellow-600"></div>;
                    case "error":
                        return <div className="w-[100%] m-2 bg-red-600"><h4>{errorMessage}</h4></div>;
                    default:
                        return <div className="w-[100%] h-10 m-2 bg-gray-500"></div>;
                }
            })()}
