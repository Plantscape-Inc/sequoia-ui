...
import { type Order, type Account, type Address } from "../../../types/pslive.type";
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex gap-4">
                            <div className="flex-1">
                                ...
                                >
                                    {billingAddress ? billingAddress.name1 : "Select Billing Address"}
                                </Button>
                            </div>
                            ...
                            <div className="flex-1">
                                ...
                                >
                                    {shippingAddress ? shippingAddress.name1 : "Select Physical Address"}
                                </Button>
                            </div>
                        </div>
