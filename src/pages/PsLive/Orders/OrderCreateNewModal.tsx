...
import { type Order, type Account, type Technician } from "../../../types/pslive.type";
...
export default function CreateOrderModal({ show, onClose, onCreate, apiUrl }: CreateOrderModalProps) {
    ...
    return (
        <>
            <Modal show={show} onClose={onClose}>
                    ...
                    <div className="space-y-3">
                        ...
                        <div>
                            ...
                            <TextInput
                                id="entrydate"
                                type="date"
                                value={newOrder.entrydate ? new Date(newOrder.entrydate).toISOString().split("T")[0] : ""}
                                onChange={e =>
                                    handleInputChange("entrydate", new Date(e.target.value).toISOString())
                                }
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <TextInput
                                ...
                                type="number"
                                value={newOrder.fp || 0}
                                onChange={e => handleInputChange("fp", Number(e.target.value))}
                            />
                        </div>
                ...
                <ModalFooter>
                    <Button onClick={handleCreateOrder} disabled={newOrder.accountlocid === "" || newOrder.technician === ""}>Create</Button>
