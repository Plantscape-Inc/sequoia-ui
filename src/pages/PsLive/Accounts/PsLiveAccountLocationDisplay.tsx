...
export default function AccountLocationDisplay({
  ...
  const handleFieldChange = (field: keyof AccountLocation, value: string) => {
  ...
  async function updateLocation(newLocation: AccountLocation) {
    try {
      ...
      alert(`Updated location ${newLocation.locationcode} successfully`);
    } catch (error) {
    ...
    <Card className="my-6">
      ...
      <div className="mt-4 grid gap-4">
        ...
        <div>
          ...
          <TextInput
            id="locationcode"
            value={localLocation.locationcode}
        ...
        {localLocation !== location && (
          <Button
            ...
            className="w-fit"
          >
            <ArrowUp className="mr-1 h-4 w-4" /> Save Changes
          </Button>
        )}
      </div>
      ...
      {/* Items Table */}
      <div className="mt-6">
        <h4 className="mb-2 text-lg font-semibold text-gray-900 dark:text-gray-200">
          Location Items
        </h4>
        <Table hoverable>
          <TableHead>
          ...
          <TableBody className="divide-y">
            ...
            <TableRow className="bg-gray-50 dark:bg-gray-700">
              <TableCell>
                <Button size="sm" color="blue" onClick={createLocationItem}>
