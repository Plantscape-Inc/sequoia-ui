...
import type {
  CompetitoryProductSummaryList,
  ProductCategorySummaryList,
  ProductMaterialSummaryList,
} from "../../types/productAnalysis.type";
  ...
  return (
    <div>
      <div>
        ...
        <form
          className="mx-auto mt-6 flex max-w-4xl flex-wrap items-end justify-center gap-4"
